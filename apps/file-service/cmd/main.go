...
func main() {
	...
	grpcServer := grpc.NewServer(
		grpc.MaxRecvMsgSize(maxMessageSize), // Увеличиваем размер принимаемых данных
		grpc.MaxSendMsgSize(maxMessageSize), // Увеличиваем размер отдаваемых данных
	)
